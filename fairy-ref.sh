...
#./fairy.py --owner FFmpeg --repo FFmpeg --gcli-account ff --patch-repo ffmpeg --podman-host 'x86_64=fairy@HOST,gpu=nvidia.com/gpu=0,device=/dev/snd/controlC10,device=/dev/snd/pcmC10D0c,device=/dev/snd/pcmC10D0p,device=/dev/snd/pcmC10D1c,device=/dev/snd/pcmC10D1p,device=/dev/snd/timer' --llm-review-cmd './pr_review_wrapper.py --podman --repo-root ffmpeg --extra-repo-root all_ffmpeg --triage-model openai:gpt-5.6-luna --model openai:gpt-5.6 --extra-model anthropic:claude-opus-4 --extra-model zai:glm-5.3 --combine-model openai:gpt-5.6-terra --verbose' --verbose --min-age-days 56 $*
