...
markdown renderer to styled lines. Everything is unit-testable
without a tty.

What does NOT belong: anything importing blessed or touching the
terminal, git-diff rendering (diff_render), and anything
review-specific (decisions, pipelines, forges).
"""
